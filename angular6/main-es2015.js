...
let ImageComponent = class ImageComponent {
    ...
    onSubmit() {
        ...
        this.http.post('http://localhost:3000/api/upload', formData).subscribe((res) => console.log(res), (err) => console.log(err));
...
let NewIdeasComponent = class NewIdeasComponent {
    ...
    onSubmit(form) {
        this.userService.postIdea(form.value).subscribe(res => {
...
NewIdeasComponent.ctorParameters = () => [
...
let VideoCenterComponent = class VideoCenterComponent {
    constructor(userService) {
        this.userService = userService;
    ...
    onSubmit(form) {
        this.userService.addVideo(form.value).subscribe((res) => {
            this.hidenewVideo = true;
...
VideoCenterComponent.ctorParameters = () => [
    { type: _user_shared_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"] }
];
...
let VideoDetilsComponent = class VideoDetilsComponent {
    constructor() {
